...
// DEBUG: flat fields to verify enrichment at top level
const _d0 = offerData.offers[0] || {};
const _d11 = offerData.offers[11] || {};
const _sizes = offerData.offers.map(o => o.party_size);
const _tiers = offerData.offers.map(o => o.tier);
...
return [{
  json: {
    ...
    _debug: {
      offer0_party_size: _d0.party_size,
      offer0_tier: _d0.tier,
      offer0_hook: _d0.hook_type,
      offer0_status: _d0.status,
      offer11_party_size: _d11.party_size,
      offer11_tier: _d11.tier,
      all_sizes: _sizes,
      all_tiers: _tiers,
      menu_items_count: offerData.menu_items.length,
      offers_count: offerData.offers.length
    }
  }
}];
"""
