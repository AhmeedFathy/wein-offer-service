function De(e){return typeof e=="object"&&e!==null?e.role:e}function de(e){const n=De(e);return n==="admin"||n==="manager"}const Re=de;function Oe(e){const n=De(e);return n==="admin"||n==="manager"||n==="deal_breaker"}const Ht={deal_breaker:["analytics","settings"],team:["analytics","settings","leads","pipeline","deals","launch","providers","offers","map","marketing"]};function ue(e){return e?Ht[e]??[]:[]}function Ne(e){return ue(e).includes("pipeline")?"tasks":"pipeline"}function O(){return window.WEIN_PORTAL_LEGACY??{}}function te(){const e=O().supabaseClient;if(!e)throw new Error("Portal Supabase client is not available yet.");return e}function ne(){const e=O().getSupabaseUrl?.();if(!e)throw new Error("Portal Supabase URL is not available yet.");return e}function jt(){const e=O().getSupabaseAnonKey?.();if(!e)throw new Error("Portal Supabase anon key is not available yet.");return e}function ae(){return O().getAccessToken?.()??null}function Wt(){return{client:te(),accessToken:ae()}}class Gt extends Error{constructor(n,t,r){super(n),this.status=t,this.body=r,this.name="PortalApiError"}status;body}function G(){const e=O().headers?.();if(e)return e;const n=jt();return{apikey:n,Authorization:`Bearer ${ae()||n}`,"Content-Type":"application/json"}}async function me(e,n){if(e.ok)return;const t=await e.text();throw new Gt(`Supabase ${n} failed: ${e.status}${t?` ${t}`:""}`,e.status,t)}async function zt(e){const n=O().get;if(n)return n(e);const t=await fetch(`${ne()}/rest/v1/${e}`,{headers:G()});return await me(t,"GET"),t.json()}async function Vt(e,n){const t=O().post;if(t)return t(e,n);const r=await fetch(`${ne()}/rest/v1/${e}`,{method:"POST",headers:{...G(),Prefer:"return=representation"},body:JSON.stringify(n)});return await me(r,"POST"),r.json()}async function Qt(e,n){const t=O().patch;return t?t(e,n):(await fetch(`${ne()}/rest/v1/${e}`,{method:"PATCH",headers:G(),body:JSON.stringify(n)})).ok}async function Yt(e){const n=O().delete;if(n)return n(e);const t=await fetch(`${ne()}/rest/v1/${e}`,{method:"DELETE",headers:G()});return await me(t,"DELETE"),!0}const Pe={headers:G,get:zt,post:Vt,patch:Qt,delete:Yt},Kt={providers:[],offers:[],negotiations:[],files:[],leads:[],outcomes:[],tasks:[],profiles:[],redemptions:[],campaigns:[],calendarNotes:[]};function Jt(){const e=O().getCaches?.();return e?{providers:e.providers??[],offers:e.offers??[],negotiations:e.negotiations??[],files:e.files??[],leads:e.leads??[],outcomes:e.outcomes??[],tasks:e.tasks??[],profiles:e.profiles??[],redemptions:e.redemptions??[],campaigns:e.campaigns??[],calendarNotes:e.calendarNotes??[]}:Kt}function T(e){return Jt()[e]}function Ue(e,n){const t=O().setCache;if(!t)throw new Error("Portal cache bridge is not available yet.");t(e,[...n])}function Xt(e,n){Ue(e,n(T(e)))}const Fe={get providers(){return T("providers")},get offers(){return T("offers")},get negotiations(){return T("negotiations")},get files(){return T("files")},get leads(){return T("leads")},get outcomes(){return T("outcomes")},get tasks(){return T("tasks")},get profiles(){return T("profiles")},get redemptions(){return T("redemptions")},get campaigns(){return T("campaigns")},get calendarNotes(){return T("calendarNotes")},getCache:T,replaceCache:Ue,updateCache:Xt};function X(){const e=window.WEIN??{};return{user:e.user,role:e.role??sessionStorage.getItem("weinRole"),fullName:e.fullName??null,accessToken:ae(),client:te()}}function Zt(){const e=X();return{api:Pe,store:Fe,session:e,permissions:{canDelete:()=>de(X()),canManageDeals:()=>Re(X()),canEditProviderProfile:()=>Oe(X()),navHiddenForRole:ue,defaultViewForRole:Ne},navigate(n,t){window.showView?.(n,t)}}}const W=new Map;let Z=null;function se(e){if(!e.id)throw new Error("View id is required.");if(W.has(e.id))throw new Error(`View already registered: ${e.id}`);W.set(e.id,e)}function xe(e){return W.get(e)}function en(){return[...W.keys()]}function tn(){if(!Z)return;const e=Z;Z=null,e()}function nn(e,n,t){const r=xe(e);if(!r)throw new Error(`Unknown portal view: ${e}`);tn();const l=r.mount(n,t);Z=typeof l=="function"?l:null}function an(){W.has("__dummy_cleanup_probe")||se({id:"__dummy_cleanup_probe",mount(e){return window.WEIN_PORTAL_DUMMY_CLEANUP_COUNT=window.WEIN_PORTAL_DUMMY_CLEANUP_COUNT??0,e.innerHTML='<div class="view-header"><div><div class="view-title">Dummy Cleanup Probe</div><div class="view-count">Registry test view</div></div></div>',()=>{window.WEIN_PORTAL_DUMMY_CLEANUP_COUNT=(window.WEIN_PORTAL_DUMMY_CLEANUP_COUNT??0)+1}}})}function sn(e="chat"){const n=globalThis.crypto?.randomUUID?.()||`${Date.now()}-${Math.random().toString(16).slice(2)}`;return`${e}-${n}`}function oe(e,n){return e.kind==="group"?e.title||"Untitled group":(e.members||[]).map(r=>r.profile).find(r=>r&&r.id!==n)?.full_name||"Direct message"}function rn(e){return[...e].sort((n,t)=>{const r=n.last_message?.created_at||n.created_at,l=t.last_message?.created_at||t.created_at;return new Date(l).getTime()-new Date(r).getTime()})}function on(e,n){const t=(e.members||[]).find(l=>l.user_id===n),r=e.last_message?.message_seq||0;return Math.max(0,r-(t?.last_read_seq||0))}function cn(e){if(!e)return"No messages yet";const n=(e.deleted_at?"Message deleted":e.body||"").trim();return n.length>82?`${n.slice(0,79)}...`:n}const ln=/[\s\p{P}]/u,dn=/[\s\p{P}]/u;function Be(e,n){return n===0?!0:ln.test(e[n-1])}function un(e,n){return n>=e.length?!0:dn.test(e[n])}function ee(e="",n=[]){const t=String(e??"");if(!t.includes("@"))return[];const r=n.filter(p=>p&&p.id&&p.full_name).map(p=>({id:p.id,name:String(p.full_name)})).sort((p,M)=>M.name.length-p.name.length);if(!r.length)return[];const l=t.toLowerCase(),c=[],u=new Set;for(let p=0;p<t.length;p+=1){if(t[p]!=="@"||!Be(t,p))continue;const M=p+1;for(const b of r){const f=M+b.name.length;if(l.startsWith(b.name.toLowerCase(),M)&&un(t,f)){u.has(b.id)||(u.add(b.id),c.push(b.id)),p=f-1;break}}}return c}function mn(e="",n=[]){const t=new Set(ee(e,n));return n.filter(r=>r&&t.has(r.id)&&r.full_name).map(r=>String(r.full_name)).sort((r,l)=>l.length-r.length)}function fn(e="",n=0){const t=String(e??""),r=Math.max(0,Math.min(Number(n)||0,t.length)),l=40;for(let c=r-1;c>=0&&r-c<=l;c-=1){const u=t[c];if(u==="@")return Be(t,c)?{query:t.slice(c+1,r),start:c}:null;if(u===`
`)return null}return null}function m(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function H(e){return{admin:"Admin",manager:"Manager",deal_breaker:"Deal breaker",team:"Team"}[e]||e}function pn(e){return`${e}-${Math.random().toString(16).slice(2)}-${Date.now().toString(36)}`}function ke(e){return typeof e=="string"&&e.startsWith("image/")}function hn(e){const n=Number(e)||0;return n<1024?`${n} B`:n<1024*1024?`${(n/1024).toFixed(1)} KB`:`${(n/(1024*1024)).toFixed(1)} MB`}function Ee(e){return e==="application/pdf"?"ti-file-type-pdf":e?.includes("word")?"ti-file-type-doc":e?.includes("sheet")||e?.includes("excel")?"ti-file-type-xls":"ti-file"}function gn(e,n=new Date){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const r=n.getTime()-t.getTime(),l=Math.floor(r/6e4);if(l<1)return"now";if(l<60)return`${l}m`;const c=Math.floor(l/60);return c<24?`${c}h`:r<6*864e5?t.toLocaleDateString(void 0,{weekday:"short"}):t.toLocaleDateString(void 0,{month:"short",day:"numeric"})}const vn=300*1e3;function _n(e,n){if(!n||e.sender_id!==n.sender_id)return!0;const t=new Date(e.created_at).getTime()-new Date(n.created_at).getTime();return!(t>=0&&t<vn)}function bn(){return{id:"team-chat",mount(e,n){const t={profiles:[],conversations:[],messages:[],selectedConversationId:null,editingMessageId:null,editDraft:"",replyToMessageId:null,composeOpen:!1,composeSearch:"",composeGroupTitle:"",composeSelectedMemberIds:new Set,membersOpen:!1,memberAddOpen:!1,memberSearch:"",memberSelectedIds:new Set,renameOpen:!1,renameDraft:"",archiveConfirmOpen:!1,mentionQuery:null,mentionIndex:0,mentionStart:0,mentionDraft:"",pendingAttachments:[],openMessageMenuId:null,confirmingDeleteMessageId:null,searchOpen:!1,searchQuery:"",searchResults:[],searchLoading:!1,searchError:null,loading:!0,error:null},r=new Map,l=new Set;let c=!1,u=n.initialConversationId||null,p=null,M=null,b=!1,f=null,$=0;function I(){const a=e.querySelector(".chat-message-list");return a?a.scrollHeight-a.scrollTop-a.clientHeight<80:!0}function L(){const a=e.querySelector(".chat-message-list");a&&(a.scrollTop=a.scrollHeight)}function v(a){a.style.height="auto",a.style.height=`${Math.min(a.scrollHeight,120)}px`}function C(a){return a?a.members.filter(s=>!s.left_at&&s.profile).map(s=>s.profile):[]}function y(a){const s=String(t.mentionQuery||"").trim().toLowerCase(),i=C(a).filter(d=>d.id!==n.currentUser.id);return s?i.filter(d=>(d.full_name||"").toLowerCase().includes(s)):i}function x({rerender:a=!0}={}){t.mentionQuery!==null&&(t.mentionQuery=null,t.mentionIndex=0,a&&g())}function B(a){t.mentionDraft=a.value;const s=fn(a.value,a.selectionStart??a.value.length),i=s?s.query:null;return i===t.mentionQuery?!1:(t.mentionQuery=i,t.mentionStart=s?s.start:0,t.mentionIndex=0,!0)}function V(a,s){const i=e.querySelector("[data-chat-composer]");if(!i||!s)return;const d=i.selectionStart??i.value.length,h=i.value.slice(0,t.mentionStart),S=i.value.slice(d),k=`@${s.full_name} `,_=`${h}${k}${S}`,q=h.length+k.length;t.mentionQuery=null,t.mentionIndex=0,t.mentionDraft=_,g();const E=e.querySelector("[data-chat-composer]");E&&(E.value=_,v(E),E.focus(),E.setSelectionRange?.(q,q))}function ge(a,s){const i=y(a);if(!i.length)return;const d=(t.mentionIndex+s+i.length)%i.length;t.mentionIndex=d;const h=e.querySelector("[data-chat-composer]")?.value??t.mentionDraft,S=e.querySelector("[data-chat-composer]")?.selectionStart??h.length;t.mentionDraft=h,g();const k=e.querySelector("[data-chat-composer]");k&&(k.value=h,v(k),k.focus(),k.setSelectionRange?.(S,S))}e.classList.add("wein-chat-root"),typeof document<"u"&&document.body?.classList.add("wein-chat-root");function ve(a){const s=a.target;if(s instanceof Element){if(t.composeOpen&&!s.closest("[data-chat-compose-popover]")&&!s.closest("[data-chat-compose-toggle]")){Y();return}if(t.membersOpen&&!s.closest("[data-chat-members-panel]")&&!s.closest("[data-chat-members-toggle]")){K();return}t.openMessageMenuId&&!s.closest("[data-chat-message-menu-panel]")&&!s.closest("[data-chat-message-menu]")&&(t.openMessageMenuId=null,g())}}function _e(a){if(a.key==="Escape"){if(t.composeOpen){Y();return}if(t.membersOpen){K();return}(t.openMessageMenuId||t.confirmingDeleteMessageId)&&(t.openMessageMenuId=null,t.confirmingDeleteMessageId=null,g())}}e.addEventListener?.("click",ve),typeof document<"u"&&document.addEventListener("keydown",_e);async function D({keepMessages:a=!0}={}){try{t.error=null;const[s,i]=await Promise.all([n.service.listProfiles(),n.service.listConversations()]);if(t.profiles=s,t.conversations=rn(i),u&&(t.conversations.some(d=>d.id===u)&&(t.selectedConversationId=u),u=null),!t.selectedConversationId&&t.conversations.length&&(t.selectedConversationId=t.conversations[0].id),t.selectedConversationId&&a){t.messages=await n.service.listMessages(t.selectedConversationId);const d=t.messages.at(-1)?.message_seq||0;if(d)try{await n.service.markRead(t.selectedConversationId,d)}catch(h){console.error("Failed to mark chat messages as read",h)}}}catch(s){t.error=s.message||String(s)}finally{t.loading=!1,c||g()}}async function Q(a){t.selectedConversationId=a,t.membersOpen=!1,t.memberAddOpen=!1,t.memberSearch="",t.memberSelectedIds=new Set,t.renameOpen=!1,t.renameDraft="",t.archiveConfirmOpen=!1,t.pendingAttachments=[],e.classList.add("chat-has-selection"),t.messages=await n.service.listMessages(a),b=!0,c||g();const s=t.messages.at(-1)?.message_seq||0;if(s)try{await n.service.markRead(a,s)}catch(i){console.error("Failed to mark chat messages as read",i)}await D()}function be(){e.classList.remove("chat-has-selection")}function re(a){const s=t.selectedConversationId;if(!s)return;const i=[...a||[]];for(const d of i){const h={id:pn("pending"),name:d.name,mime:d.type||"application/octet-stream",size:d.size,status:"uploading",error:null,uploaded:null};t.pendingAttachments=[...t.pendingAttachments,h],n.service.uploadAttachment(s,d).then(S=>{h.status="done",h.uploaded=S,c||g()}).catch(S=>{h.status="error",h.error=S?.message||"Upload failed",c||g()})}g()}function Qe(a){t.pendingAttachments=t.pendingAttachments.filter(s=>s.id!==a),g()}async function Ye(a){const s=a.querySelector("[data-chat-composer]"),i=s.value.trim(),d=t.pendingAttachments.some(E=>E.status==="uploading"),h=t.pendingAttachments.filter(E=>E.status==="done").map(E=>E.uploaded);if(d||!i&&!h.length||!t.selectedConversationId)return;const S=t.replyToMessageId,k=t.conversations.find(E=>E.id===t.selectedConversationId)||null,_=ee(i,C(k));s.value="",t.replyToMessageId=null,t.mentionQuery=null,t.mentionDraft="",t.pendingAttachments=[];const q=await n.service.sendMessage({conversationId:t.selectedConversationId,body:i,clientNonce:sn("portal-chat"),replyToId:S,mentionedUserIds:_,attachments:h});t.messages=[...t.messages,q],b=!0,c||g();try{await n.service.markRead(t.selectedConversationId,q.message_seq)}catch(E){console.error("Failed to mark chat message as read",E)}await D()}function Ke(a){a&&(t.replyToMessageId=a,g(),e.querySelector("[data-chat-composer]")?.focus())}function Je(){t.replyToMessageId=null,g()}function Xe(){t.composeOpen=!0,g(),e.querySelector("[data-chat-compose-search]")?.focus()}function Y({reset:a=!1}={}){t.composeOpen=!1,a&&(t.composeSearch="",t.composeGroupTitle="",t.composeSelectedMemberIds=new Set),g()}function Ze(){t.searchOpen=!0,t.composeOpen=!1,g(),e.querySelector("[data-chat-search-input]")?.focus()}function ie(){t.searchOpen=!1,t.searchQuery="",t.searchResults=[],t.searchLoading=!1,t.searchError=null,f&&clearTimeout(f),g()}async function et(a){const s=a.trim();if(!s){t.searchResults=[],t.searchLoading=!1,t.searchError=null,c||g();return}const i=++$;t.searchLoading=!0,t.searchError=null,c||g();try{const d=await n.service.searchMessages(s);if(c||i!==$)return;t.searchResults=d,t.searchLoading=!1,g()}catch(d){if(c||i!==$)return;t.searchError=d instanceof Error?d.message:String(d),t.searchLoading=!1,g()}}function tt(a){t.searchQuery=a,f&&clearTimeout(f),f=setTimeout(()=>et(a),300)}async function nt(a,s){if(ie(),await Q(a),c)return;const i=Array.from(e.querySelectorAll("[data-chat-message-id]")).find(d=>d.dataset.chatMessageId===s);i&&(i.scrollIntoView({block:"center"}),i.classList.add("chat-message-jumped"),setTimeout(()=>i.classList.remove("chat-message-jumped"),1600))}function at(a,s){const i=new Set(t.composeSelectedMemberIds);s?i.add(a):i.delete(a),t.composeSelectedMemberIds=i,g()}function ye(a){return a.members.find(i=>i.user_id===n.currentUser.id&&!i.left_at)?.membership_role==="owner"||["admin","manager"].includes(n.currentUser.role)}function we(a){return!a||a.kind!=="group"?!1:ye(a)}function st(a){return a?ye(a):!1}function rt(){t.membersOpen=!0,g()}function K({reset:a=!1}={}){t.membersOpen=!1,t.memberAddOpen=!1,a&&(t.memberSearch="",t.memberSelectedIds=new Set),g()}function it(){t.memberAddOpen=!t.memberAddOpen,g(),t.memberAddOpen&&e.querySelector("[data-chat-member-search]")?.focus()}function ot(a,s){const i=new Set(t.memberSelectedIds);s?i.add(a):i.delete(a),t.memberSelectedIds=i,g()}async function ct(a){const s=[...t.memberSelectedIds];if(!(!a||!s.length)){for(const i of s)await n.service.addMember(a,i);t.memberSearch="",t.memberSelectedIds=new Set,t.memberAddOpen=!1,c||g(),await D()}}async function lt(a,s){!a||!s||(await n.service.removeMember(a,s),t.conversations=t.conversations.map(i=>i.id!==a?i:{...i,members:i.members.map(d=>d.user_id===s?{...d,left_at:d.left_at||new Date().toISOString()}:d)}),s===n.currentUser.id&&(t.membersOpen=!1,t.memberAddOpen=!1),c||g(),await D())}function dt(a){const s=t.messages.find(d=>d.id===a);if(!s)return;t.editingMessageId=a,t.editDraft=s.body||"",g();const i=e.querySelector(`[data-chat-edit-input="${CSS.escape(a)}"]`);i?.focus(),i?.select?.()}function ut(){t.editingMessageId=null,t.editDraft="",g()}async function mt(a){const s=a.dataset.chatEditForm,d=a.querySelector("[data-chat-edit-input]").value.trim();if(!s||!d)return;const h=t.conversations.find(k=>k.id===t.selectedConversationId)||null,S=await n.service.updateMessage(s,d,ee(d,C(h)));t.messages=t.messages.map(k=>k.id===S.id?S:k),t.editingMessageId=null,t.editDraft="",c||g(),await D()}async function ft(a){if(!a)return;const s=await n.service.deleteMessage(a);t.messages=t.messages.map(i=>i.id===a?{...i,...s,body:"Message deleted",deleted_at:s.deleted_at||new Date().toISOString()}:i),t.replyToMessageId===a&&(t.replyToMessageId=null),t.confirmingDeleteMessageId=null,t.openMessageMenuId=null,c||g(),await D()}async function pt(a){const i=a.members.find(d=>d.user_id===n.currentUser.id)?.notification_level==="muted"?"all":"muted";await n.service.setNotificationLevel(a.id,i),t.conversations=t.conversations.map(d=>d.id!==a.id?d:{...d,members:d.members.map(h=>h.user_id===n.currentUser.id?{...h,notification_level:i}:h)}),c||g(),await D()}function ht(a){t.renameOpen=!0,t.renameDraft=a.title||"",g(),e.querySelector("[data-chat-rename-input]")?.focus()}function gt(){t.renameOpen=!1,t.renameDraft="",g()}async function vt(a,s){const i=(s||"").trim();i&&(await n.service.renameConversation(a.id,i),t.conversations=t.conversations.map(d=>d.id===a.id?{...d,title:i}:d),t.renameOpen=!1,t.renameDraft="",c||g(),await D())}function _t(){t.archiveConfirmOpen=!0,g()}function bt(){t.archiveConfirmOpen=!1,g()}async function yt(a,s){await n.service.setConversationArchived(a.id,s),t.archiveConfirmOpen=!1,t.selectedConversationId===a.id&&(t.selectedConversationId=null,be()),t.conversations=t.conversations.map(i=>i.id===a.id?{...i,archived_at:new Date().toISOString()}:i),c||g(),await D()}async function wt(a,s,i){!a||!s||(await n.service.setMembershipRole(a,s,i),t.conversations=t.conversations.map(d=>d.id!==a?d:{...d,members:d.members.map(h=>h.user_id===s?{...h,membership_role:i}:h)}),c||g(),await D())}async function St(a){if(!a)return;const s=await n.service.getOrCreateDm(a);t.composeOpen=!1,t.composeSearch="",t.composeGroupTitle="",t.composeSelectedMemberIds=new Set,await Q(s)}async function $t(a,s){if(a=a.trim(),!a)return;const i=await n.service.createGroup(a,s);t.composeOpen=!1,t.composeSearch="",t.composeGroupTitle="",t.composeSelectedMemberIds=new Set,await Q(i)}function kt(){c||D()}function Et(a){const s=a.id===t.selectedConversationId?" selected":"",i=a.unread_count?`<span class="chat-count">${a.unread_count}</span>`:"",d=oe(a,n.currentUser.id),S=a.kind==="group"?'<span class="chat-conversation-hash" aria-hidden="true">#</span>':`<span class="chat-conversation-avatar" aria-hidden="true">${m((d||"?").slice(0,1).toUpperCase())}</span>`;return`
          <button type="button" class="chat-conversation${s}" data-chat-select="${m(a.id)}">
            ${S}
            <span class="chat-conversation-title">${m(d)}</span>
            ${i}
          </button>
        `}function Mt(a){const s=t.conversations.find(S=>S.id===a.conversation_id),i=s?oe(s,n.currentUser.id):"Archived conversation",d=gn(a.created_at),h=a.sender?.full_name||"Unknown";return`
          <button type="button" class="chat-search-result" data-chat-search-result="${m(a.conversation_id)}" data-chat-search-message="${m(a.id)}">
            <span class="chat-search-result-row">
              <span class="chat-search-result-title">${m(i)}</span>
              ${d?`<span class="chat-search-result-time">${m(d)}</span>`:""}
            </span>
            <span class="chat-search-result-snippet"><strong>${m(h)}:</strong> ${m(cn(a))}</span>
          </button>
        `}function Ct(){const a=t.searchQuery.trim();return`
          <div class="chat-search-panel">
            <div class="chat-search-input-row">
              <i class="ti ti-search"></i>
              <input data-chat-search-input type="search" placeholder="Search messages..." value="${m(t.searchQuery)}" autocomplete="off">
            ...
            <div class="chat-search-results">
              ...
              ${t.searchError?`<div class="chat-error"><i class="ti ti-alert-triangle"></i><span>${m(t.searchError)}</span></div>`:""}
              ...
              ${t.searchLoading?"":t.searchResults.map(Mt).join("")}
            </div>
          </div>
        `}function It(){return["admin","manager"].includes(n.currentUser.role)}function Tt(a){if(!t.composeOpen)return"";const s=t.composeSearch.trim().toLowerCase(),i=a.filter(S=>!s||(S.full_name||"").toLowerCase().includes(s)),d=t.composeSelectedMemberIds.size,h=d===1?[...t.composeSelectedMemberIds][0]:"";return`
          <div class="chat-compose-popover" data-chat-compose-popover role="dialog" aria-label="New conversation">
            ...
            <div class="chat-compose-actions">
              <button type="button" data-chat-start-dm="${m(h)}"${d===1?"":" disabled"}><i class="ti ti-message"></i><span>Start DM</span></button>
        ...
        `}function qt(a){if(t.mentionQuery===null||!a)return"";const s=y(a);if(!s.length)return"";const i=Math.min(t.mentionIndex,s.length-1);return`
        ...
        `}function Lt(a){if(!t.membersOpen||!a||a.kind!=="group")return"";const s=a.members.filter(_=>!_.left_at),i=we(a),d=new Set(s.map(_=>_.user_id)),h=t.memberSearch.trim().toLowerCase(),S=t.profiles.filter(_=>_.id!==n.currentUser.id&&!d.has(_.id)&&(!h||(_.full_name||"").toLowerCase().includes(h))),k=t.memberSelectedIds.size;return`
            ...
            <div class="chat-member-panel-list">
              ${s.map(_=>{const q=_.profile||{},E=_.user_id===n.currentUser.id,J=i||E;return`
                  <div class="chat-member-row" data-chat-member-row="${m(_.user_id)}">
                    <span class="chat-compose-avatar">${m((q.full_name||"?").slice(0,1))}</span>
                    <span class="chat-compose-person-copy">
                      <strong>${m(q.full_name||_.user_id)}</strong>
                      <span>${m(q.role?H(q.role):"Member")}</span>
                    </span>
                ...
                ${t.memberAddOpen?`
                  ...
                  <div class="chat-compose-list">
                    ${S.map(_=>{const q=t.memberSelectedIds.has(_.id)?" checked":"";return`
                        <label class="chat-compose-person">
                          <input type="checkbox" data-chat-member-pick="${m(_.id)}"${q}>
        ...
        `}function Se(a){const s=a.deleted_at?"Message deleted":a.body||"";return s.length>90?`${s.slice(0,87)}...`:s}function At(a){if(!a?.reply_to_id)return"";const s=t.messages.find(i=>i.id===a.reply_to_id);return s?`
          <div class="chat-quote">
            <strong>${m(s.sender?.full_name||"Unknown")}</strong>
            <span>${m(Se(s))}</span>
          </div>
        `:'<div class="chat-quote"><span>Replying to a message</span></div>'}function Dt(){const a=t.messages.find(s=>s.id===t.replyToMessageId);return a?`
        ...
        `:""}function Rt(){return t.pendingAttachments.length?`
          <div class="chat-pending-attachments">
            ${t.pendingAttachments.map(a=>`
              <div class="chat-pending-attachment${a.status==="error"?" error":""}" data-chat-pending-attachment="${m(a.id)}">
                <i class="ti ${a.status==="error"?"ti-alert-triangle":ke(a.mime)?"ti-photo":Ee(a.mime)}"></i>
        ...
        `:""}function Ot(a){const s=r.get(a.path),i=s&&s.expiresAt>Date.now()?s.url:null;return ke(a.mime)?i?`<a class="chat-attachment-image-link" href="${m(i)}" target="_blank" rel="noopener">
          ...
          <a class="chat-attachment-file" href="${i?m(i):"#"}" target="_blank" rel="noopener" data-chat-attachment-path="${m(a.path)}">
            <i class="ti ${Ee(a.mime)}"></i>
            <span class="chat-attachment-file-copy">
              <strong>${m(a.name)}</strong>
              <span>${m(hn(a.size))}</span>
            </span>
            <i class="ti ti-download"></i>
          </a>
        `}function Nt(a){return a.attachments?.length?`<div class="chat-message-attachments">${a.attachments.map(Ot).join("")}</div>`:""}async function Pt(){const a=new Set;for(const i of t.messages)for(const d of i.attachments||[])a.add(d.path);let s=!1;for(const i of a){const d=r.get(i);if(!(d&&d.expiresAt>Date.now()||l.has(i))){l.add(i);try{const h=await n.service.getSignedAttachmentUrl(i);r.set(i,{url:h,expiresAt:Date.now()+3300*1e3}),s=!0}catch(h){console.error("Failed to sign chat attachment URL",h)}finally{l.delete(i)}}}s&&!c&&g()}function Ut(a){return`
        ...
        `}function Ft(a){const s=m(a.body),i=t.conversations.find(_=>_.id===a.conversation_id)||t.conversations.find(_=>_.id===t.selectedConversationId)||null,d=C(i),h=mn(a.body,d);if(!h.length)return s;const S=new Set(d.filter(_=>_.id===n.currentUser.id).map(_=>String(_.full_name)));let k=s;for(const _ of h){const q=`@${m(_)}`,E=S.has(_)?"chat-mention chat-mention-self":"chat-mention";k=k.split(q).join(`<span class="${E}">${q}</span>`)}return k}function xt(a,s=!0){const i=a.sender_id===n.currentUser.id?" mine":"",d=!!a.deleted_at,h=i&&!d,S=!d&&(i||It()),k=a.edited_at&&!d?'<span class="chat-edited">(edited)</span>':"",_=d?"":`
            <button type="button" data-chat-reply="${m(a.id)}" aria-label="Reply"><i class="ti ti-corner-up-left"></i></button>
            ${h?`<button type="button" data-chat-edit="${m(a.id)}" aria-label="Edit message"><i class="ti ti-pencil"></i></button>`:""}
        ...
        `;return`
          <div class="chat-message${i}${d?" deleted":""}${s?"":" chat-message-grouped"}" tabindex="0" data-chat-message-id="${m(a.id)}">
            ...
            `:""}
            ${At(a)}
            ${t.editingMessageId===a.id?Ut(a):`
              ${a.body.trim()?`<div class="chat-message-body">${d?m("Message deleted"):Ft(a)}</div>`:""}
              ${d?"":Nt(a)}
            `}
            ${q}
          </div>
        `}function g(){const a=b||I();b=!1;const s=t.conversations.find(o=>o.id===t.selectedConversationId)||null,i=t.profiles.filter(o=>o.id!==n.currentUser.id),h=s?.members.find(o=>o.user_id===n.currentUser.id)?.notification_level==="muted",S=s?.members.filter(o=>!o.left_at)||[],k=s?we(s):!1,_=s?st(s):!1;e.innerHTML=`
            ...
            <main class="chat-thread">
              ...
              ${s?`
                ...
                <div class="chat-message-list">
                  ${t.messages.map((o,w)=>xt(o,_n(o,t.messages[w-1]))).join("")}
        ...
        `,e.querySelectorAll("[data-chat-select]").forEach(o=>{o.addEventListener("click",()=>Q(o.dataset.chatSelect))}),e.querySelector("[data-chat-back]")?.addEventListener("click",()=>be()),e.querySelector("[data-chat-toggle-mute]")?.addEventListener("click",()=>{s&&pt(s)}),e.querySelector("[data-chat-members-toggle]")?.addEventListener("click",()=>{s&&(t.membersOpen?K():rt())}),e.querySelector("[data-chat-members-close]")?.addEventListener("click",()=>K({reset:!0})),e.querySelector("[data-chat-rename-toggle]")?.addEventListener("click",()=>{s&&ht(s)}),e.querySelector("[data-chat-rename-cancel]")?.addEventListener("click",()=>gt()),e.querySelector("[data-chat-rename-form]")?.addEventListener("submit",o=>{o.preventDefault(),s&&vt(s,t.renameDraft)}),e.querySelector("[data-chat-rename-input]")?.addEventListener("input",o=>{t.renameDraft=o.currentTarget.value}),e.querySelector("[data-chat-archive-toggle]")?.addEventListener("click",()=>_t()),e.querySelector("[data-chat-confirm-archive]")?.addEventListener("click",()=>{s&&yt(s,!0)}),e.querySelector("[data-chat-cancel-archive]")?.addEventListener("click",()=>bt()),e.querySelector("[data-chat-member-add-toggle]")?.addEventListener("click",()=>it()),e.querySelector("[data-chat-member-search]")?.addEventListener("input",o=>{t.memberSearch=o.currentTarget.value,g();const w=e.querySelector("[data-chat-member-search]");w?.focus(),w?.setSelectionRange?.(w.value.length,w.value.length)}),e.querySelectorAll("[data-chat-member-pick]").forEach(o=>{o.addEventListener("change",()=>ot(o.dataset.chatMemberPick,o.checked))}),e.querySelector("[data-chat-add-members]")?.addEventListener("click",o=>{ct(o.currentTarget.dataset.chatAddMembers)}),e.querySelectorAll("[data-chat-remove-member]").forEach(o=>{o.addEventListener("click",()=>{s&&lt(s.id,o.dataset.chatRemoveMember)})}),e.querySelectorAll("[data-chat-promote-member]").forEach(o=>{o.addEventListener("click",()=>{s&&wt(s.id,o.dataset.chatPromoteMember,o.dataset.chatRole)})}),e.querySelector("[data-chat-search-toggle]")?.addEventListener("click",()=>{t.searchOpen?ie():Ze()}),e.querySelector("[data-chat-search-close]")?.addEventListener("click",()=>ie()),e.querySelector("[data-chat-search-input]")?.addEventListener("input",o=>{tt(o.currentTarget.value),g();const w=e.querySelector("[data-chat-search-input]");w?.focus(),w?.setSelectionRange?.(w.value.length,w.value.length)}),e.querySelectorAll("[data-chat-search-result]").forEach(o=>{o.addEventListener("click",()=>{nt(o.dataset.chatSearchResult,o.dataset.chatSearchMessage)})}),e.querySelector("[data-chat-compose-toggle]")?.addEventListener("click",()=>{t.composeOpen?Y():Xe()}),e.querySelector("[data-chat-compose-close]")?.addEventListener("click",()=>Y()),e.querySelector("[data-chat-compose-search]")?.addEventListener("input",o=>{t.composeSearch=o.currentTarget.value,g();const w=e.querySelector("[data-chat-compose-search]");w?.focus(),w?.setSelectionRange?.(w.value.length,w.value.length)}),e.querySelectorAll("[data-chat-compose-member]").forEach(o=>{o.addEventListener("change",()=>at(o.dataset.chatComposeMember,o.checked))}),e.querySelector("[data-chat-group-title]")?.addEventListener("input",o=>{t.composeGroupTitle=o.currentTarget.value,g();const w=e.querySelector("[data-chat-group-title]");w?.focus(),w?.setSelectionRange?.(w.value.length,w.value.length)}),e.querySelector("[data-chat-start-dm]")?.addEventListener("click",o=>{St(o.currentTarget.dataset.chatStartDm)}),e.querySelector("[data-chat-create-group]")?.addEventListener("click",()=>{$t(t.composeGroupTitle,[...t.composeSelectedMemberIds])});const q=e.querySelector("[data-chat-send-form]");q?.addEventListener("submit",o=>{o.preventDefault(),Ye(o.currentTarget)});const E=e.querySelector("[data-chat-composer]");E?.addEventListener("input",()=>{if(v(E),!B(E))return;const{value:o,selectionStart:w}=E;g();const N=e.querySelector("[data-chat-composer]");N&&(N.value=o,v(N),N.focus(),N.setSelectionRange?.(w,w))}),E?.addEventListener("keydown",o=>{if(t.mentionQuery!==null&&s){const w=y(s);if(w.length){if(o.key==="ArrowDown"){o.preventDefault(),ge(s,1);return}if(o.key==="ArrowUp"){o.preventDefault(),ge(s,-1);return}if(o.key==="Enter"||o.key==="Tab"){o.preventDefault(),V(s,w[Math.min(t.mentionIndex,w.length-1)]);return}}if(o.key==="Escape"){o.preventDefault(),x();return}}o.key==="Enter"&&!o.shiftKey&&(o.preventDefault(),q?.requestSubmit())}),e.querySelectorAll("[data-chat-mention-pick]").forEach(o=>{o.addEventListener("mousedown",w=>{w.preventDefault();const N=C(s).find(Bt=>Bt.id===o.dataset.chatMentionPick);N&&V(s,N)})}),e.querySelector("[data-chat-clear-reply]")?.addEventListener("click",()=>Je()),e.querySelectorAll("[data-chat-reply]").forEach(o=>{o.addEventListener("click",()=>Ke(o.dataset.chatReply))}),e.querySelectorAll("[data-chat-edit]").forEach(o=>{o.addEventListener("click",()=>dt(o.dataset.chatEdit))}),e.querySelectorAll("[data-chat-delete]").forEach(o=>{o.addEventListener("click",()=>{t.confirmingDeleteMessageId=o.dataset.chatDelete,t.openMessageMenuId=null,g()})}),e.querySelectorAll("[data-chat-message-menu]").forEach(o=>{o.addEventListener("click",()=>{t.openMessageMenuId=t.openMessageMenuId===o.dataset.chatMessageMenu?null:o.dataset.chatMessageMenu,t.confirmingDeleteMessageId=null,g()})}),e.querySelectorAll("[data-chat-confirm-delete]").forEach(o=>{o.addEventListener("click",()=>ft(o.dataset.chatConfirmDelete))}),e.querySelectorAll("[data-chat-cancel-delete]").forEach(o=>{o.addEventListener("click",()=>{t.confirmingDeleteMessageId===o.dataset.chatCancelDelete&&(t.confirmingDeleteMessageId=null),g()})}),e.querySelectorAll("[data-chat-edit-form]").forEach(o=>{o.addEventListener("submit",w=>{w.preventDefault(),mt(w.currentTarget)})}),e.querySelectorAll("[data-chat-cancel-edit]").forEach(o=>{o.addEventListener("click",()=>ut())});const J=e.querySelector("[data-chat-file-input]");e.querySelector("[data-chat-attach-toggle]")?.addEventListener("click",()=>J?.click()),J?.addEventListener("change",o=>{re(o.currentTarget.files),o.currentTarget.value=""}),e.querySelectorAll("[data-chat-remove-pending]").forEach(o=>{o.addEventListener("click",()=>Qe(o.dataset.chatRemovePending))});const $e=e.querySelector("[data-chat-send-form]");$e?.addEventListener("dragover",o=>o.preventDefault()),$e?.addEventListener("drop",o=>{o.preventDefault(),o.dataTransfer?.files?.length&&re(o.dataTransfer.files)}),E?.addEventListener("paste",o=>{const w=[...o.clipboardData?.files||[]];w.length&&re(w)}),a&&L(),Pt()}return D(),p=setInterval(()=>D(),3e4),typeof n.service.subscribeToConversationEvents=="function"&&(M=n.service.subscribeToConversationEvents(()=>kt())),()=>{c=!0,p&&clearInterval(p),f&&clearTimeout(f),M&&M(),e.removeEventListener?.("click",ve),typeof document<"u"&&(document.removeEventListener("keydown",_e),document.body?.classList.remove("wein-chat-root")),e.classList.remove("wein-chat-root"),e.classList.remove("chat-has-selection"),e.innerHTML=""}}}}const Me="chat-attachments",Ce=5;function He(e){return String(e||"file").replace(/[^a-zA-Z0-9._-]+/g,"_")}function yn(e,n){const t=`${Date.now().toString(36)}-${Math.random().toString(16).slice(2,8)}`;return`${e}/${t}-${He(n)}`}function wn(e){return String(e).replace(/[\\%_]/g,n=>`\\${n}`)}function P(e,n){if(e.error)throw new Error(`${n}: ${e.error.message||e.error}`);return e.data||[]}function j(e,n){if(e.error)throw new Error(`${n}: ${e.error.message||e.error}`);return e.data}function fe(e){return e?{id:e.id,full_name:e.full_name,role:e.role,email:e.email??null}:null}function Sn(e){return{conversation_id:e.conversation_id,user_id:e.user_id,membership_role:e.membership_role,joined_at:e.joined_at,left_at:e.left_at,last_read_seq:Number(e.last_read_seq||0),notification_level:e.notification_level,profile:fe(e.profile||e.profiles)}}function F(e){return{id:e.id,conversation_id:e.conversation_id,message_seq:Number(e.message_seq||0),sender_id:e.sender_id,body:e.body,reply_to_id:e.reply_to_id,client_nonce:e.client_nonce,created_at:e.created_at,edited_at:e.edited_at,deleted_at:e.deleted_at,mentioned_user_ids:e.mentioned_user_ids||[],attachments:e.attachments||[],sender:fe(e.sender||e.profiles)}}function Ie(e,n){const t=(e.members||e.wein_chat_members||[]).map(Sn),r=e.last_message||e.wein_chat_messages||[],l=Array.isArray(r)?r.find(p=>p.deleted_at==null):null,c=l?F(l):null,u={id:e.id,kind:e.kind,title:e.title,created_by:e.created_by,created_at:e.created_at,archived_at:e.archived_at,members:t,last_message:c,unread_count:0};return u.unread_count=on(u,n),u}function je({supabase:e,currentUserId:n}){if(!e)throw new Error("supabase client is required");if(!n)throw new Error("currentUserId is required");async function t(r){const l=await e.from("wein_chat_conversations").select(`
      ...
      `).eq("id",r).order("message_seq",{referencedTable:"wein_chat_messages",ascending:!1}).limit(Ce,{referencedTable:"wein_chat_messages"}).single();if(l.error)throw new Error(`fetch conversation: ${l.error.message||l.error}`);return Ie(l.data,n)}return{async listProfiles(){const r=await e.from("profiles").select("id, full_name, role, email").order("full_name",{ascending:!0});return P(r,"list profiles").map(fe)},async listConversations(){const r=await e.from("wein_chat_conversations").select(`
          id, kind, title, created_by, created_at, archived_at,
          members:wein_chat_members(
            conversation_id, user_id, membership_role, joined_at, left_at, last_read_seq, notification_level,
            profile:profiles(id, full_name, role, email)
        ...
        `).is("archived_at",null).order("created_at",{ascending:!1}).order("message_seq",{referencedTable:"wein_chat_messages",ascending:!1}).limit(Ce,{referencedTable:"wein_chat_messages"});return P(r,"list conversations").map(l=>Ie(l,n))},async listMessages(r){const l=await e.from("wein_chat_messages").select(`
          id, conversation_id, message_seq, sender_id, body, reply_to_id, client_nonce, created_at, edited_at, deleted_at, mentioned_user_ids, attachments,
          sender:profiles(id, full_name, role, email)
        ...
        `}function L(){const v=qn(t.comments),C=t.replyToId?t.comments.find(y=>y.id===t.replyToId):null;e.innerHTML=`
          <section class="discussion-shell" aria-label="${A(qe(n.scope))}">
            <header class="discussion-header">
              <div>
                <div class="discussion-eyebrow">${A(qe(n.scope))}</div>
                <h2>Discussion</h2>
                <p>${A(An(n.scope))}</p>
              </div>
        ...
        `,e.querySelector("[data-inbox-refresh]")?.addEventListener("click",()=>u()),e.querySelectorAll("[data-inbox-item]").forEach($=>{$.addEventListener("click",()=>{const I=$.dataset.inboxItem,L=t.items.find(v=>`${v.kind}:${v.entity_id}:${v.reason_code}`===I);L&&p(L)})})}return u(),l=setInterval(()=>u(),6e4),typeof n.service.subscribeToInboxEvents=="function"&&(c=n.service.subscribeToInboxEvents(()=>u())),()=>{r=!0,l&&clearInterval(l),c&&c(),e.classList.remove("wein-work-inbox-root"),e.innerHTML=""}}}}const Le={critical:0,high:1,medium:2,low:3};function pe(e,n=new Date){if(!e)return"low";const t=new Date(e);if(Number.isNaN(t.getTime()))return"low";const r=t.getTime()-n.getTime();return r<0?"critical":r<=1440*60*1e3?"high":r<=4320*60*1e3?"medium":"low"}function xn(e,{now:n=new Date}={}){return{kind:"task",entity_id:e.id,title:e.title||"Untitled task",reason_code:e.due_date?"task_due":"task_open",severity:pe(e.due_date,n),owner_id:e.assigned_to_user_id||e.owner_id||null,due_at:e.due_date||null,next_action:"Open task",href:`#tasks/${e.id}`,source:e}}function Bn(e,{comment:n,currentUserId:t}={}){return{kind:"mention",entity_id:e.comment_id,title:n?.body?`Mention: ${n.body}`:"Mention in discussion",reason_code:"unresolved_mention",severity:n?.resolved_at?"low":"high",owner_id:t||e.mentioned_user_id,due_at:n?.created_at||e.created_at||null,next_action:"Reply or resolve",href:`#comments/${e.comment_id}`,source:{mention:e,comment:n}}}function Hn(e,{currentUserId:n,now:t=new Date}={}){return{kind:"discussion",entity_id:e.id,title:e.body||"Discussion awaiting reply",reason_code:"thread_awaiting_reply",severity:pe(e.next_reply_due_at||e.created_at,t),owner_id:n||null,due_at:e.next_reply_due_at||null,next_action:"Reply in thread",href:`#comments/${e.id}`,source:e}}function jn(e,{now:n=new Date}={}){return{kind:e.kind||"review",entity_id:e.id,title:e.title||e.offer_title||"Founder review needed",reason_code:e.reason_code||"founder_review",severity:pe(e.due_at||e.created_at,n),owner_id:e.owner_id||null,due_at:e.due_at||e.created_at||null,next_action:"Review",href:e.href||`#review/${e.id}`,source:e}}function Wn(e=[]){return[...e].sort((n,t)=>{const r=(Le[n.severity]??9)-(Le[t.severity]??9);return r||String(n.due_at||"").localeCompare(String(t.due_at||""))})}function Gn(e=[]){const n=new Set;return e.filter(t=>{const r=`${t.kind}:${t.entity_id}:${t.reason_code}`;return n.has(r)?!1:(n.add(r),!0)})}function zn({tasks:e=[],mentions:n=[],commentsById:t={},awaitingReplies:r=[],founderReviews:l=[]},c={}){const u=[...e.map(p=>xn(p,c)),...n.map(p=>Bn(p,{...c,comment:t[p.comment_id]})),...r.map(p=>Hn(p,c)),...l.map(p=>jn(p,c))];return Wn(Gn(u))}function Ae(e){if(e)throw e}function Vn({supabase:e,currentUserId:n}){if(!e)throw new Error("Supabase client is required");if(!n)throw new Error("currentUserId is required");async function t(){let u=e.from("wein_tasks").select("*").neq("status","done").order("due_date",{ascending:!0,nullsFirst:!1});n&&(u=u.eq("assigned_to_user_id",n));const{data:p,error:M}=await u;return Ae(M),p||[]}async function r(){const{data:u,error:p}=await e.from("wein_comment_mentions").select("comment_id,mentioned_user_id,created_at,wein_comments(*)").eq("mentioned_user_id",n).is("wein_comments.resolved_at",null).order("created_at",{ascending:!0});return Ae(p),u||[]}async function l(){const[u,p]=await Promise.all([t(),r()]),M={},b=p.map(f=>{const $=f.wein_comments||f.comment||null;return $?.id&&(M[$.id]=$),{comment_id:f.comment_id,mentioned_user_id:f.mentioned_user_id,created_at:f.created_at}});return zn({tasks:u,mentions:b,commentsById:M},{currentUserId:n})}function c(u){if(!e.channel)return()=>{};const p=e.channel(`work-inbox:${n}`).on("postgres_changes",{event:"*",schema:"public",table:"wein_tasks"},u).on("postgres_changes",{event:"*",schema:"public",table:"wein_comments"},u).on("postgres_changes",{event:"*",schema:"public",table:"wein_comment_mentions"},u).subscribe();return()=>{if(e.removeChannel)return e.removeChannel(p);if(p?.unsubscribe)return p.unsubscribe()}}return{fetchOpenTasks:t,fetchUnresolvedMentions:r,loadInbox:l,subscribeToInboxEvents:c}}const Ge=["today","tasks","team","map","providers","files","leads","offers","marketing","deals","launch","analytics","settings","pipeline"];function Qn(e){for(const n of Ge)se({id:n,mount:()=>{e[n]()}})}function he(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}const Yn=["all","Dining","Health & Beauty","Fun & Activities","Hotels & Aqua Park"];function Kn(e,n){return`<div style="display:flex;gap:8px;align-items:center;margin-bottom:14px;flex-wrap:wrap;">${Yn.map(t=>`<button class="chip ${e===t?"active":""}" type="button" onclick="${n}('${t.replace(/'/g,"\\'")}')">${t==="all"?"All":he(t)}</button>`).join("")}</div>`}function Jn(e,n){return n==="all"||String(e||"")===n}function Xn(e){return String(e?.category||e?.vertical||"-")}function Zn(e){const n=String(e||"").toLowerCase();return n.includes("dining")?"dining":n.includes("health")?"health":n.includes("fun")?"fun":n.includes("hotel")?"hotels":""}function ea(e,n=Date.now()){return e?Math.floor((n-new Date(e).getTime())/864e5):0}function le(e=new Date){const n=new Date(e);return n.setHours(0,0,0,0),n}function ta(e,n=new Date){return e?Math.round((le(n).getTime()-le(e).getTime())/864e5):null}function ze(e,n){let t=String(e||"").replace(/\D/g,"");if(!t)return null;t.startsWith("0")&&(t=`20${t.slice(1)}`);const r=`Hi! Following up on the WeIN offer sheet for ${n} - do you have 5 minutes today?`;return`https://wa.me/${t}?text=${encodeURIComponent(r)}`}function na(e,n){const t=ze(e,n);return t?`<a class="mini-btn" href="${he(t)}" target="_blank" rel="noopener" onclick="event.stopPropagation()" style="color:#25D366;border-color:#25D366;text-decoration:none;"><i class="ti ti-brand-whatsapp"></i><span>WhatsApp</span></a>`:""}function z(e){return e.id}function aa(e){return T("profiles").find(n=>z(n)===e)??null}function sa(e){return T("providers").find(n=>z(n)===e)??null}function ra(e){return T("leads").find(n=>z(n)===e)??null}function ia(e){return T("tasks").find(n=>z(n)===e)??null}function oa(e){return T("offers").find(n=>z(n)===e)??null}function ca(e){return T("offers").filter(n=>n.provider_id===e)}function la(e){return T("tasks").filter(n=>n.provider_id===e)}function da(e){return T("tasks").filter(n=>n.lead_id===e)}const ua=Object.freeze(Object.defineProperty({__proto__:null,leadById:ra,offerById:oa,offersForProvider:ca,profileById:aa,providerById:sa,taskById:ia,tasksForLead:da,tasksForProvider:la},Symbol.toStringTag,{value:"Module"}));function ma(){const e=document.title;let n=!1;async function t(){const l=window.WEIN?.user?.id;if(l)try{const u=await je({supabase:te(),currentUserId:l}).listConversations(),p=Cn(u),M=document.querySelector("[data-chat-unread-badge]");M&&(M.textContent=String(p),M.style.display=p>0?"inline-flex":"none"),document.title=In(e,p)}catch{}}const r=setInterval(()=>{window.WEIN?.user?.id&&!n&&(n=!0,clearInterval(r),setInterval(t,3e4)),t()},2e3)}an();Mn();ma();const Ve={api:Pe,auth:{canDelete:de,canManageDeals:Re,canEditProviderProfile:Oe,navHiddenForRole:ue,defaultViewForRole:Ne},platform:{getSupabaseClient:te,getAccessToken:ae,getSessionContext:Wt},shared:{escapeHtml:he,daysSince:ea,startOfLocalDay:le,dayDiffFromToday:ta,whatsappLink:ze,whatsappButtonHtml:na,categoryChipsHtml:Kn,matchesCategoryFilter:Jn,categoryLabel:Xn,catBadgeClass:Zn},core:{createPortalContext:Zt,getView:xe,mountView:nn,registeredViewIds:en,registerView:se},legacy:{LEGACY_VIEW_IDS:Ge,registerLegacyViews:Qn},features:{requestOpenChatConversation:En,createDiscussionViewModule:Dn,createSupabaseDiscussionService:Rn,createWorkInboxViewModule:Fn,createSupabaseWorkInboxService:Vn},store:Fe,selectors:ua};window.WEIN_PORTAL_MODULES=Ve;for(const e of window.WEIN_PORTAL_MODULES_READY??[])e(Ve);window.WEIN_PORTAL_MODULES_READY=[];
